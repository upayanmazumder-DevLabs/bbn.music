<script lang="ts">
	...
	const variantClasses: Record<Variant, string> = {
		...
		ghost:
			'bg-transparent hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white focus:ring-gray-500',
		danger:
