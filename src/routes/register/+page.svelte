	...
	<div class="w-full max-w-md">
		<div class="glass rounded-2xl p-8 space-y-6 border border-white/10">
			...
			<div class="text-center">
				...
				<p class="mt-2 text-gray-500 dark:text-gray-400">Join bbn.music today</p>
			</div>
			...
			<form onsubmit={handleSubmit} class="space-y-5">
				...
				<div class="flex items-start">
					...
					<label for="agreeToTerms" id="terms-label" class="ml-2.5 text-sm text-gray-400">
						I agree to the
						<a href="/terms" class="text-orange-400 hover:text-orange-300 hover:underline"
							>Terms of Service</a
						>
						and
						<a href="/privacy" class="text-orange-400 hover:text-orange-300 hover:underline"
							>Privacy Policy</a
						>
					</label>
				</div>
			...
			<div class="relative">
				...
				<div class="relative flex justify-center text-sm">
					<span class="px-3 bg-white dark:bg-gray-900/80 text-gray-500">Or sign up with</span>
				</div>
			</div>
