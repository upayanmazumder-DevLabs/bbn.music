...
<div class="max-w-4xl mx-auto space-y-6">
	...
	<div class="prose prose-invert max-w-none space-y-6 text-gray-300">
		<section>
			...
			<p>
				This Privacy Notice describes our practices related to personal information collected through BBN websites and mobile versions, unless there is a separate privacy notice for the website or mobile version.
			</p>
		</section>

		<section>
			<Heading tag="h2" class="text-white text-xl font-bold">Does this Notice apply to all BBN Websites?</Heading>
			<p>
		...
		<section>
			<Heading tag="h2" class="text-white text-xl font-bold">What personal information does BBN collect?</Heading>
			<p>
			...
			<p>
				Your mobile provider may have a conflicting privacy position that captures personal information when you visit our website, but BBN is not responsible for and does not control how other parties may collect your information when you access our website(s).
			</p>
		</section>

		<section>
			<Heading tag="h2" class="text-white text-xl font-bold">How does BBN use the personal information it collects?</Heading>
			...
			<ul class="list-disc pl-6 space-y-2">
				...
				<li>support the sale or transfer of all or a portion of our business or assets (including through bankruptcy); and/or</li>
				<li>conduct investigations to ensure compliance with, and comply with, legal obligations.</li>
			</ul>
			<p>
				Information that individuals submit to express interest in, or be considered for, an employment opportunity with BBN is covered by the applicable Indeed Privacy Policy.
			</p>
			<p>
		...
		<section>
			<Heading tag="h2" class="text-white text-xl font-bold">Where does BBN store your information?</Heading>
			<p>
		...
		<section>
			<Heading tag="h2" class="text-white text-xl font-bold">Does BBN use your personal information to contact you?</Heading>
			<p>
				BBN does not use the personal information collected on this website to contact you except in response to a direct inquiry or if you register for communications in the Investors section of this site.
			</p>
		</section>

		<section>
			<Heading tag="h2" class="text-white text-xl font-bold">Does BBN share the information it collects with any third parties?</Heading>
			<p>
		...
		<section>
			<Heading tag="h2" class="text-white text-xl font-bold">How long does BBN retain personal information?</Heading>
			<p>
		...
		<section>
			<Heading tag="h2" class="text-white text-xl font-bold">How does BBN use cookies or other tracking technologies?</Heading>
			<p>
			...
			<p>
				BBN may also use cookies and similar technology placed by one of our business partners to enable BBN to learn which advertisements bring users to our website.
			</p>
		</section>

		<section>
			<Heading tag="h2" class="text-white text-xl font-bold">What should you understand about the third-party links that may appear on this website?</Heading>
			<p>
		...
		<section>
			<Heading tag="h2" class="text-white text-xl font-bold">What additional information should specific users know?</Heading>
			...
			<p>
				California Shine the Light Law: California residents may annually request and obtain information that is shared with other businesses for their own direct marketing use within the prior calendar year. BBN does not share your personal information with other businesses for their own direct marketing use.
			</p>
			<p>
				California Consumer Privacy Act: Except for those who interact with BBN as employees and contractors, those whose information we have because of their relationship with employees and contractors (such as family members receiving health benefits or emergency contacts), job applicants, those whose information we have because of their relationship with job applicants (such as references), and those whose information we have as a result of a business-to-business interaction or relationship (such the personnel of a business customer or vendor), California residents have the right to:
			</p>
			<ul class="list-disc pl-6 space-y-2">
				<li>request details about the personal information that we have about you, including the categories of information, the purpose for which we use it, with whom we share it, and specific information about what personal information we have about you specifically;</li>
				<li>request that your data be deleted; and</li>
				<li>direct a company not to sell your data, but, since BBN does not sell personal information, this does not apply.</li>
			</ul>
			<p>
				If you are a California resident not covered by the exclusions mentioned above and you would like to exercise your rights, you should contact BBN by emailing us at support@bbn.music.
			</p>

			<p class="font-semibold mt-4">Users from the European Union and other countries with privacy laws:</p>
			<p>
		...
		<section>
			<Heading tag="h2" class="text-white text-xl font-bold">How might BBN change this policy?</Heading>
			<p>
