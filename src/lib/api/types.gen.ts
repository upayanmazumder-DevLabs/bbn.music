...
export type UserAuditHistoryEvent = {
	_id: ObjectId;
	userId: ObjectId;
	storeToken?: string;
	type: 'auth' | 'refresh-auth' | 'action';
...
export type Platform = 'whatsapp' | 'email' | 'instagram' | 'facebook' | 'rcs' | 'sms';
...
export type SingleAdminDrop = {
	...
	events?: Array<UserAuditHistoryEvent>;
...
export type GetIdByDropsByAdminResponse =
	GetIdByDropsByAdminResponses[keyof GetIdByDropsByAdminResponses];
...
export type GetDownloadByFileByFilesByAdminResponse =
	GetDownloadByFileByFilesByAdminResponses[keyof GetDownloadByFileByFilesByAdminResponses];
...
export type GetPayoutsByAdminResponse =
	GetPayoutsByAdminResponses[keyof GetPayoutsByAdminResponses];
...
export type GetQueryBySearchByAdminResponse =
	GetQueryBySearchByAdminResponses[keyof GetQueryBySearchByAdminResponses];
...
export type GetIdByWalletsByAdminResponse =
	GetIdByWalletsByAdminResponses[keyof GetIdByWalletsByAdminResponses];
...
export type GetConversationsByMessagingData = {
	body?: never;
	path?: never;
	query?: {
		_lastId?: string;
...
export type GetConversationsByMessagingResponses = {
	/**
	 * Successful operation
	 */
...
export type GetConversationsByMessagingResponse =
	GetConversationsByMessagingResponses[keyof GetConversationsByMessagingResponses];

export type PostConversationsByMessagingData = {
	body?: {
		userId: string;
		platform: 'whatsapp' | 'email' | 'rcs' | 'sms';
		subject?: string;
	};
	path?: never;
	query?: never;
...
export type PostConversationsByMessagingResponses = {
	/**
	 * Successful operation
	 */
	200: {
...
export type PostConversationsByMessagingResponse =
	PostConversationsByMessagingResponses[keyof PostConversationsByMessagingResponses];

export type GetIdByConversationsByMessagingData = {
	body?: never;
	path: {
		id: string;
	};
...
export type GetIdByConversationsByMessagingResponses = {
	/**
	 * Successful operation
	 */
	200: {
...
export type GetIdByConversationsByMessagingResponse =
	GetIdByConversationsByMessagingResponses[keyof GetIdByConversationsByMessagingResponses];

export type PutSendByConversationsByMessagingData = {
	body?: {
...
export type PutSendByConversationsByMessagingResponses = {
	/**
	 * Successful operation
	 */
	200: {
...
export type GetIdByUserByMessagesByMessagingResponses = {
	/**
	 * Successful operation
	 */
	200: Array<Message>;
...
export type GetIdByUserByMessagesByMessagingResponse =
	GetIdByUserByMessagesByMessagingResponses[keyof GetIdByUserByMessagesByMessagingResponses];

export type GetWebhookByMetaByMessagingData = {
	body?: {
		[key: string]: unknown;
	};
	path?: never;
...
export type PostWebhookByMetaByMessagingData = {
	body?: {
		[key: string]: unknown;
	};
	path?: never;
...
export type GetMyConversationsByMessagingData = {
	body?: never;
	path?: never;
	query?: {
		_lastId?: string;
...
export type GetMyConversationsByMessagingResponses = {
	/**
	 * Successful operation
	 */
	200: Array<Conversation>;
...
export type GetMyConversationsByMessagingResponse =
	GetMyConversationsByMessagingResponses[keyof GetMyConversationsByMessagingResponses];

export type GetIdByMyConversationsByMessagingData = {
	body?: never;
	path: {
		id: string;
	};
...
export type GetIdByMyConversationsByMessagingResponses = {
	/**
	 * Successful operation
	 */
	200: {
...
export type PutPreferencesByMessagingResponses = {
	/**
	 * Successful operation
	 */
	200: {
...
export type PutPreferencesByMessagingResponse =
	PutPreferencesByMessagingResponses[keyof PutPreferencesByMessagingResponses];

export type GetIdByPreferencesByMessagingData = {
	body?: never;
	path: {
		id: string;
	};
...
export type GetIdByPreferencesByMessagingResponses = {
	/**
	 * Successful operation
	 */
...
export type GetIdByPreferencesByMessagingResponse =
	GetIdByPreferencesByMessagingResponses[keyof GetIdByPreferencesByMessagingResponses];

export type GetChatsByWhatsappByMessagingData = {
	body?: never;
	path?: never;
	query?: {
		_lastId?: string;
...
export type GetChatsByWhatsappByMessagingResponses = {
	/**
	 * Successful operation
	 */
	200: Array<{
...
export type GetChatsByWhatsappByMessagingResponse =
	GetChatsByWhatsappByMessagingResponses[keyof GetChatsByWhatsappByMessagingResponses];

export type GetIdByChatsByWhatsappByMessagingData = {
	body?: never;
	path: {
		id: string;
	};
...
export type GetIdByChatsByWhatsappByMessagingResponses = {
	/**
	 * Successful operation
	 */
	200: Array<WaEvent>;
...
export type GetIdByChatsByWhatsappByMessagingResponse =
	GetIdByChatsByWhatsappByMessagingResponses[keyof GetIdByChatsByWhatsappByMessagingResponses];
...
export type GetArtistsByMusicResponse =
	GetArtistsByMusicResponses[keyof GetArtistsByMusicResponses];
...
export type PostArtistsByMusicResponse =
	PostArtistsByMusicResponses[keyof PostArtistsByMusicResponses];
...
export type PostDropByDropsByMusicResponse =
	PostDropByDropsByMusicResponses[keyof PostDropByDropsByMusicResponses];
...
export type GetDownloadByDropByDropsByMusicResponse =
	GetDownloadByDropByDropsByMusicResponses[keyof GetDownloadByDropByDropsByMusicResponses];
...
export type GetIdByDropsByMusicResponse =
	GetIdByDropsByMusicResponses[keyof GetIdByDropsByMusicResponses];
...
export type PostShareByDropsByMusicResponse =
	PostShareByDropsByMusicResponses[keyof PostShareByDropsByMusicResponses];
...
export type GetIdByShareByDropsByMusicResponse =
	GetIdByShareByDropsByMusicResponses[keyof GetIdByShareByDropsByMusicResponses];
...
export type GetFulldropByMusicResponse =
	GetFulldropByMusicResponses[keyof GetFulldropByMusicResponses];
...
export type GetIdByProviderByPublishByMusicResponse =
	GetIdByProviderByPublishByMusicResponses[keyof GetIdByProviderByPublishByMusicResponses];
...
export type GetIdByShazamByMusicResponse =
	GetIdByShazamByMusicResponses[keyof GetIdByShazamByMusicResponses];
...
export type GetIdBySongsByMusicResponse =
	GetIdBySongsByMusicResponses[keyof GetIdBySongsByMusicResponses];
...
export type GetDownloadBySongBySongsByMusicResponse =
	GetDownloadBySongBySongsByMusicResponses[keyof GetDownloadBySongBySongsByMusicResponses];
...
export type GetApplicationsByOauthResponse =
	GetApplicationsByOauthResponses[keyof GetApplicationsByOauthResponses];
...
export type GetDownloadByClientByApplicationsByOauthResponse =
	GetDownloadByClientByApplicationsByOauthResponses[keyof GetDownloadByClientByApplicationsByOauthResponses];
...
export type GetUserinfoByOauthResponse =
	GetUserinfoByOauthResponses[keyof GetUserinfoByOauthResponses];
...
export type GetPayoutsByPaymentResponse =
	GetPayoutsByPaymentResponses[keyof GetPayoutsByPaymentResponses];
...
export type GetIdByPayoutsByPaymentResponse =
	GetIdByPayoutsByPaymentResponses[keyof GetIdByPayoutsByPaymentResponses];
...
export type PutPlaceholderByTasksResponse =
	PutPlaceholderByTasksResponses[keyof PutPlaceholderByTasksResponses];
