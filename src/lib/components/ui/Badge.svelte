<script lang="ts">
	...
	type Color = 'orange' | 'blue' | 'green' | 'red' | 'purple' | 'gray';
	...
	const { color = 'gray', size = 'md', class: className = '', children }: Props = $props();
...
<span
	class="inline-flex items-center font-medium rounded-md ring-1 ring-inset {colorClasses[
		color
